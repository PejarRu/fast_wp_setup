...
class Admin_Pages
{
    ...
    public function __construct() {
        // Move menu registration here
        add_action('admin_menu', [$this, 'savour_manager_menu']);
    }

    // Admin menu and page rendering
    public function savour_manager_menu()
    {
        add_menu_page(
            'Savour Manager v.1',
            'Savour Manager v.1',
     ...
     */
    public function savour_manager_desactivar_comentarios()
    {
     ...
     */
    public function savour_manager_activate_hello_theme()
    {
    ...
    public function savour_manager_page()
    {
