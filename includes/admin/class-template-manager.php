...
class Template_Manager
{
     ...
     */
    public function insert_elementor_template($full_exported_json, $post_title, $template_type, $condition = 'include/general', $export_type = '')
    {
     ...
     */
    public function create_header_from_json()
    {
     ...
     */
    public function create_footer_from_json()
    {
        if (! has_theme_builder()) {
     ...
     */
    public function create_single_from_json()
    {
        if (! has_theme_builder()) {
     ...
     */
    public function create_abogado_from_json()
    {
        if (! has_theme_builder()) {
     ...
     */
    public function get_template_by_type($type, $export_type = '')
    {
        $meta_query = [
            'relation' => 'AND',
            [
